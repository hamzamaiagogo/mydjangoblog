...
<head>
    ...
    <title>Maiagogo - {% block title %}Contact!{% endblock %}</title>
...
<header class="intro-header" style="background-image: url({% static 'style/img/contact-bg.jpg' %})">
<div class="container">
            <div class="row">
