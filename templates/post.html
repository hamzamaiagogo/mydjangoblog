...
<p>All
people have a unique combination of talents, knowledge and skills--strengths--that they use to do their work ,achieve their goal and interact with others every day.when people understand and apply their strengths, the effect on their lives is transformational.People who use their strengths, every day are six times more likely to be engaged in their work and three times more likely to say they have an excelent quality of life.
Yet, Many people don't even know what their talents are or have the opportunity to build them in to strengths. In pact many people spent Their lives focused on fixing their weaknesses instead.</p>

<p>What
 makes the biggest developmental different in someone's life is having atleaast one person who not only loves and cares about him but who also recognizes and respects his individuality. Someone who encourages him to excel. Someone who sees the best in him. Someone who helps him find pathways that take him in positive directions.</p>
<a href="#">
<img class="img-responsive" src= "{% static 'style/img/alb.jpeg' %}" width="100%" height="100" alt="">
</a>
...
<h2 class="section-heading">Activator </h2>
<p>
"When can we start?"
...
You know you will be judged not by what you say, not by what you think, but by what you get done. This does not frighten you.It pleases you.</p>

<a href="#">
<img class="img-responsive" src= "{% static 'style/img/ahamza.jpg' %}" width="100%" height="200" alt="">
</a>
<span class="caption text-muted">To go places and do things that have never been done before – that’s what living is all about.</span>
...
<p>Spaceflights
cannot be stopped. This is not the work of any one man or even a group 
of men. It is a historical process which mankind is carrying out in 
accordance with the natural laws of human development.</p>

<h2 class="section-heading">Reaching for the Stars</h2>

<p>As
we got further and further away, it [the Earth] diminished in size. 
...
<a href="#">
<img class="img-responsive" src= "{% static 'style/img/post-sample-image.jpg' %}" alt="">
</a>
<span class="caption text-muted">To go places and do things that have never been done before – that’s what living is all about.</span>
...
<p>As
I stand out here in the wonders of the unknown at Hadley, I sort of 
